...
class _$_Reply implements _Reply {
  ...
  @override
  String toString() {
    return 'Reply(uid: $uid, reply: $reply, likeCount: $likeCount, postRef: $postRef, postCommentRef: $postCommentRef, postCommentReplyId: $postCommentReplyId, userName: $userName, userImageURL: $userImageURL, createdAt: $createdAt)';
  }
...
abstract class _Reply implements Reply {
  const factory _Reply(
      ...
      required final dynamic createdAt}) = _$_Reply;
